...
# Check if all coordinates are missing
if missing_locations.empty:
    print("All locations have valid coordinates.")
else:
    print(f"{len(missing_locations)} locations are missing coordinates.")

# Step 6: Convert to GeoDataFrame only if there are valid coordinates
